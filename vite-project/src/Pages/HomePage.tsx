        ...
        <div className='workExperience' data-aos="fade-up" data-aos-delay="300">
          <div className='left-section'>
            <WorkCard
              ...
              introduction="Supported local pricing operations and helped automate freight quoting, improving team efficiency and accuracy."
            />
            <WorkCard
              ...
              introduction="Handled cross-team coordination and client rate requests, contributing to client acquisition and service improvements."
            />
            <WorkCard
              ...
              introduction="Assisted in financial audits, developing strong attention to detail and document verification skills."
            />
          </div>
          ...
          <div className='right-section'>
            <WorkCard
              ...
              introduction="Worked on an IT audit for a public hospital, gaining experience in system controls and data integrity assessments."
            />
            <WorkCard
              ...
              introduction="Supported fintech sales with client profiling and risk review, enhancing screening and approval efficiency."
            />
          </div>
        </div>
      </div>
